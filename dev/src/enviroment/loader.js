...
C.Enviroment.LoaderInterface = function () {
...
C.mode(C.Enviroment, 'LoaderInterface', C.MODE_LOCKED);

/**
 * @constructor
 * @extends {C.Enviroment.LoaderInterface}
 */
C.Enviroment.Loader = new C.Enviroment.LoaderInterface();
C.implement(C.Enviroment.Loader, function () {
